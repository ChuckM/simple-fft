/*
 * Fixed point oscillator experiment using an octant table
 *
...
#define PLOT_FILE "plots/octant-test.plot"
...
char *exp_title = "Octant Table lookup";
...
int main(int argc, char *argv[]) {
	...
	printf("Harmonic Osciallor: Octant Table Lookup experiment.\n");
...
#define AMPLITUDE_SQUARED	(AMPLITUDE * AMPLITUDE)
	...
	for (int i = 1; i < data1->n; i++) {
		...
		/* Use the octant lookup version, no bias */
		osc16o(rps[sel].c, rps[sel].s, &cur, &nxt);
